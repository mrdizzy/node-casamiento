...
vows.describe("eBay Trading API").addBatch({
    ...
    "when another successful request is made in json": {
        topic: function() {
            fixture("get_orders_response");
            api.makeRequest("GetOrders", this.callback, null, "json");
        },
        "the Timestamp attribute should be correct": function(result) {
            console.log(result["OrderArray"][1]);
        }
    }
    ...
    "When making request": {
        ...
        "there should be well-formed XML": function(topic) {
