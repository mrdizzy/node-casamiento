var cradle = require('cradle');// port should be 443
    ...
    // var connection =new(cradle.Connection)('https://984c464d-1c23-4359-81fb-561712a67b6a-bluemix.cloudant.com', 443, {
    // secure: true,
    //     auth: {
...
databases.test_ebay = connection.database("casamiento");
