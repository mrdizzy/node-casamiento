...
var ProductView = Backbone.View.extend({
  ...
  render: function() {
    this.$el.html(this.model.get("_id") + '<a href="/personalised_place_cards/' + this.model.get("_id") + '">' + this.model.get("_id") + "</a> | " + '<a href="/products/images/' + this.model.get("_id") + '">image</a>' + "<span class='destroy'>destroy</span>");
    return this;
  }
});
