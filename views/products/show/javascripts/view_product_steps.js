...
var StepView = Backbone.View.extend({
  ...
  initialize: function() {
    ...
    this.weights_reference = {
        2: "200",
        3: "300"
      } // number refers to position of element in HTML hierarchy
  ...
  _renderQuickGuests: function() {
    this.$('#quick_guests').val(this.guests.pluck("name").join("\n"))
  },
